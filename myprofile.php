...
?>
<center><h3><Welcome:<?php echo $rows['ps_name'];?></h3></center>
        ...
        <li class="current-page">My Profile</li>
   	        ...
   	        <div class="col-sm-4 row_2">
				...
				<table class="table_working_hours">
		        	...
		        	<tbody>
					 ...
					 <tr class="opened_1">
						...
						<tr class="opened_1">
							<td class="day_label">Willing to marry from other communities :</td>
							<td class="day_value"><?php echo $rows['ps_willing'];?></td>
						</tr>
						<tr class="opened_1">
				...
				<div class="form-actions">
				  ...
				  <button class="btn_1 submit"  id="edit-submit" name="update" onclick="document.location='mybasic.php'">Edit Profile</button>
			  </div>
